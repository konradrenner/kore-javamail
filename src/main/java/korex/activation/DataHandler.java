...
import kore.awt.datatransfer.Transferable;
 ...
 *
 * @see korex.activation.CommandMap
 * @see korex.activation.DataContentHandler
 * @see korex.activation.DataSource
 * @see korex.activation.URLDataSource
 */
...
public class DataHandler implements Transferable {
     ...
     *
     * @see korex.activation.DataContentHandler#writeTo
     * @see korex.activation.UnsupportedDataTypeException
     */
     ...
     *
     * @see korex.activation.DataSource#getOutputStream
     * @see korex.activation.URLDataSource
     */
     ...
     * @see korex.activation.DataContentHandler#getTransferDataFlavors
     */
     ...
     * @see korex.activation.DataHandler#getTransferDataFlavors
     */
     ...
     * @exception IOException	if an I/O error occurs
     * @see korex.activation.ActivationDataFlavor
     */
     ...
     *
     * @see korex.activation.CommandMap#setDefaultCommandMap
     */
     ...
     *
     * @see korex.activation.CommandMap#getPreferredCommands
     */
     ...
     *
     * @see korex.activation.CommandMap#getAllCommands
     */
     ...
     *
     * @see korex.activation.CommandMap#getCommand
     */
     ...
     * the <code>korex.activation.DataHandler</code> class itself.
     *
     ...
     *
     * @see korex.activation.DataContentHandlerFactory
     */
