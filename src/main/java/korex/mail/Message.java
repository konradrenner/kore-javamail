...
public abstract class Message implements Part {
     ...
     * </pre></blockquote>
     *
     * @see korex.mail.Message#getRecipients
     * @see korex.mail.Message#setRecipients
     * @see korex.mail.Message#addRecipients
     */
     ...
     *			obtained from a READ_ONLY folder.
     * @exception       MessagingException for other failures
     * @see		korex.mail.event.MessageChangedEvent
     */
     ...
     * @exception       MessagingException for failures
     * @see		korex.mail.search.SearchTerm
     */
