...
public abstract class Folder {
     ...
     * @see 		#HOLDS_FOLDERS
     * @see		#HOLDS_MESSAGES
     * @see		korex.mail.event.FolderEvent
     */
     ...
     * @see 		#READ_WRITE
     * @see 		#getType()
     * @see 		korex.mail.event.ConnectionEvent
     */
     ...
     * @see		korex.mail.event.MessageCountEvent
     */
     ...
     * @exception       korex.mail.search.SearchException if the search 
