 ...
 * @see	korex.mail.internet.MimeUtility
 * @see	korex.mail.Part
 * @see	korex.mail.Message
 * @see	korex.mail.internet.MimePart
 * @see	korex.mail.internet.InternetAddress
 */
...
public class MimeMessage extends Message implements MimePart {
     ...
     * @see		#headers
     * @see		korex.mail.Message.RecipientType#TO
     * @see		korex.mail.Message.RecipientType#CC
     * @see		korex.mail.Message.RecipientType#BCC
     * @see		korex.mail.internet.MimeMessage.RecipientType#NEWSGROUPS
     */
     ...
     * @exception	MessagingException for failures
     * @see             korex.activation.DataHandler
     */
     ...
     * @see        korex.mail.search.MessageIDTerm
     * @since 	   JavaMail 1.1
     */
     ...
     *			korex.activation.DataHandler for more details.
     * @exception	MessagingException for other failures
     *
     * @see	#getContentStream
     * @see 	korex.activation.DataHandler#getInputStream
     */
     ...
     * @return          Object
     * @see		korex.mail.Part
     * @see 		korex.activation.DataHandler#getContent
     * @exception       IOException this is typically thrown by the
     *			DataHandler. Refer to the documentation for
     *			korex.activation.DataHandler for more details.
     * @exception       MessagingException for other failures
     ...
     * {@link korex.mail.Flags.Flag#ANSWERED ANSWERED} flag is set
     * in this message. <p>
     *
     * The "Subject" field is filled in with the original subject
     * prefixed with "Re:" (unless it already starts with "Re:").
     ...
     *				korex.activation layer.
     * @exception MessagingException for other failures
     * @see korex.activation.DataHandler#writeTo
     */
     ...
     *				or if an error is generated by the
     *				korex.activation layer.
     * @exception korex.mail.MessagingException for other failures
     * @see korex.activation.DataHandler#writeTo
     */
     ...
     * @exception       MessagingException for failures
     * @see 		korex.mail.Flags.Flag
     * @see		korex.mail.Flags.Flag#ANSWERED
     * @see		korex.mail.Flags.Flag#DELETED
     * @see		korex.mail.Flags.Flag#DRAFT
     * @see		korex.mail.Flags.Flag#FLAGGED
     * @see		korex.mail.Flags.Flag#RECENT
     * @see		korex.mail.Flags.Flag#SEEN
     */
