 ...
 * @see korex.mail.Session#getInstance(java.util.Properties,
 *					korex.mail.Authenticator)
 * @see korex.mail.Session#getDefaultInstance(java.util.Properties,
 *					korex.mail.Authenticator)
 * @see korex.mail.Session#requestPasswordAuthentication
 * @see korex.mail.PasswordAuthentication
 *
 * @author  Bill Foote
 * @author  Bill Shannon
 */
...
public abstract class Authenticator {
     ...
     * @return the protcol
     *
     * @see korex.mail.URLName#getProtocol
     */
