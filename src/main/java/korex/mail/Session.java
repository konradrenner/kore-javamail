 ...
 * <code>korex.mail.Address</code> returns the address type.  The
 ...
 * <code>korex.mail.Address</code> implementation that is present if it is
 * to be used.  For example, the
 * <code>korex.mail.internet.InternetAddress</code> method
...
public final class Session {
	...
	try {
	    Class[] c = {korex.mail.Session.class, korex.mail.URLName.class};
