 ...
 * {@linkplain korex.mail.Authenticator} class used to provide login credentials
 ...
 * {@linkplain korex.mail.internet.MimeUtility#getDefaultJavaCharset() default}
 * platform encoding).
 *
 ...
 * (defaults to the {@linkplain korex.mail.Message#setFrom() local address})
 *
 ...
 * {@linkplain korex.mail.internet.InternetAddress#getLocalAddress
 * local address}.)
 *
 ...
 * a {@linkplain korex.mail.internet.MimeMessage#writeTo raw}
 ...
 * store, {@linkplain korex.mail.internet.MimeMessage#MimeMessage(
 * korex.mail.Session, java.io.InputStream) reconstruct}, and resend the
...
public class MailHandler extends Handler {
    ...
    private String contentWithEncoding(String type, String encoding) {
        ...
        try {
            ...
            encoding = ct.toString(); //See korex.mail.internet.ContentType.
            if (!isEmpty(encoding)) {
                type = encoding;
            }
